...
STRIP_EXCEPTIONS = ["carp_en", "minerva_math", "livecodebench"]
...
def parse_ground_truth(example: Dict[str, Any], data_name):
    ...
    if data_name in ["math", "minerva_math"]:
        ...
        # LiveCodeBench doesn't need evaluation, just set dummy values
        gt_cot, gt_ans = None, "N/A"
    else:
...
def parse_question(example, data_name):
    ...
    if data_name == "asdiv":
        ...
        # For LiveCodeBench, combine question title and content
        question_title = example.get("question_title", "")
        question_content = example.get("question_content", example.get("question", ""))
